...
public class TestSuperposition
{
	public static void main(String[] args)
	{
		...
		Superposition super1 = new Superposition("../src/images/david_tennant.png", "../src/images/david_tennant.png");
		...
		Superposition super2 = new Superposition("../src/images/david_tennant.png", "../src/images/david_tennant.png");
